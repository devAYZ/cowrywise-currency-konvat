...
struct SymbolsListResponse: Codable {
    var success: Bool?
    var error: ErrorResponse?
    var symbols: SymbolsList?
}

struct SymbolsList: Codable {
    ...
    var symbolsAndValueDictionary: [String: String] {
        let mirror = Mirror(reflecting: self) // Reflect properties
